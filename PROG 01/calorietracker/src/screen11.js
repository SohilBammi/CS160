 ...
 */
 ...
 var quantity12= 0;
 var quantity13= 0;
 var itemNames = ["Harmless Coconut Water Bottles", "Plates of Spaghetti", "Bananas", "Pop Tarts", "Big Macs", 
 "Medium Fries", "Tacos", "Slices of Bread", "Chocolate Cakes", "Plates of Pad Thai", "IHOP Chorizo Fiesta Omelettes", 
  "Boba Milk Teas with Grass Jelly", "Cups of Black Coffee", "Grande Caramel Frapuccinos"];
 var itemCalories = [120, 600, 105, 200, 563, 365, 189, 79, 350, 889, 1990, 316, 5, 420];
...
export var Screen11Template = Container.template($ => ({
