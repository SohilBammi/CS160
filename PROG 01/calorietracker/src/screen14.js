 ...
 */
 ...
 var quantity12= 0;
 var quantity13= 0;
 var itemNames = ["Grande Caramel Frapuccinos", "Plates of Spaghetti", "Bananas", "Pop Tarts", "Big Macs", 
  ...
  "Boba Milk Teas with Grass Jelly", "Cups of Black Coffee"];
 var itemCalories = [420, 600, 105, 200, 563, 365, 189, 79, 350, 889, 1990, 120, 316, 5];
...
export var Screen14Template = Container.template($ => ({
