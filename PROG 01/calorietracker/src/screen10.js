 ...
 */
 ...
 var quantity12= 0;
 var quantity13= 0;
 var itemNames = ["IHOP Chorizo Fiesta Omelettes", "Plates of Spaghetti", "Bananas", "Pop Tarts", "Big Macs", "Medium Fries", "Tacos", "Slices of Bread",
  "Chocolate Cakes", "Plates of Pad Thai", "Harmless Coconut Water Bottles", 
  "Boba Milk Teas with Grass Jelly", "Cups of Black Coffee", "Grande Caramel Frapuccinos"];
 var itemCalories = [1990, 600, 105, 200, 563, 365, 189, 79, 350, 889, 120, 316, 5, 420];
...
export var Screen10Template = Container.template($ => ({
