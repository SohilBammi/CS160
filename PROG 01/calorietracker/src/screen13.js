 ...
 */
 ...
 var quantity12= 0;
 var quantity13= 0;
 var itemNames = ["Cups of Black Coffee", "Plates of Spaghetti", "Bananas", "Pop Tarts", "Big Macs", "Medium Fries", 
  "Tacos", "Slices of Bread", "Chocolate Cakes", "Plates of Pad Thai", "IHOP Chorizo Fiesta Omelettes", "Harmless Coconut Water Bottles", 
  "Boba Milk Teas with Grass Jelly", "Grande Caramel Frapuccinos"];
 var itemCalories = [5, 600, 105, 200, 563, 365, 189, 79, 350, 889, 1990, 120, 316, 420];
...
export var Screen13Template = Container.template($ => ({
