 ...
 */
 ...
 var quantity13= 0;
 var quantity14= 0;
 var itemNames = ["Calories", "Plates of Spaghetti", "Bananas", "Pop Tarts", "Big Macs", "Medium Fries", "Tacos", "Slices of Bread",
  "Chocolate Cakes", "Plates of Pad Thai", "IHOP Chorizo Fiesta Omelettes", "Harmless Coconut Water Bottles", 
  "Boba Milk Teas with Grass Jelly", "Cups of Black Coffee", "Grande Caramel Frapuccinos"];
 var itemCalories = [0, 600, 105, 200, 563, 365, 189, 79, 350, 889, 1990, 120, 316, 5, 420];

 function updateCalories(){
 	var totalCalories = quantity;
...
export var ScreenCTemplate = Container.template($ => ({
