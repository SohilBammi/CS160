 ...
 */
 ...
 var quantity12= 0;
 var quantity13= 0;
 var itemNames = ["Plates of Pad Thai", "Plates of Spaghetti", "Bananas", "Pop Tarts", "Big Macs", "Medium Fries", 
 "Tacos", "Slices of Bread", "Chocolate Cakes", "IHOP Chorizo Fiesta Omelettes", "Harmless Coconut Water Bottles", 
  "Boba Milk Teas with Grass Jelly", "Cups of Black Coffee", "Grande Caramel Frapuccinos"];
 var itemCalories = [889, 600, 105, 200, 563, 365, 189, 79, 350, 1990, 120, 316, 5, 420];
...
export var Screen9Template = Container.template($ => ({
